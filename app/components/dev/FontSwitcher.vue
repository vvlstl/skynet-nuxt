<script setup lang="ts">
	...
	const headingFonts: FontOption[] = [
		...
		{label: 'Jura', value: 'Jura', weights: [700]},
		{label: 'Exo 2', value: 'Exo2', weights: [700, 900]},
		{label: 'Tektur', value: 'Tektur', weights: [700, 900]},
		{label: 'Unbounded', value: 'Unbounded', weights: [700, 900]},
		{label: 'Ampero', value: 'Ampero', weights: [700]},
		{label: 'Bender', value: 'Bender', weights: [700, 900]},
		{label: 'Oswald', value: 'Oswald', weights: [700]},
		{label: 'New CM Mono', value: 'NewCMMono10', weights: [700]},
	]

	const bodyFonts: FontOption[] = [
		{label: 'Rajdhani', value: 'Rajdhani', weights: [400]},
		{label: 'Bender', value: 'Bender', weights: [300, 400]},
		{label: 'Gamestation Display', value: 'Gamestation-Display', weights: [400]},
		{label: 'Gamestation Extended', value: 'Gamestation-Extended', weights: [400]},
		{label: 'Oswald', value: 'Oswald', weights: [400]},
		{label: 'Akrobat', value: 'Akrobat', weights: [300, 400]},
		{label: 'Ampero', value: 'Ampero', weights: [300, 400]},
		{label: 'Bellota Text', value: 'BellotaText', weights: [300, 400]},
		{label: 'Departura', value: 'Departura', weights: [200]},
		{label: 'Exo 2', value: 'Exo2', weights: [300, 400]},
		{label: 'Fira Sans', value: 'FiraSans', weights: [300, 400]},
		{label: 'Jura', value: 'Jura', weights: [300, 400]},
		{label: 'Manrope', value: 'Manrope', weights: [300, 400]},
		{label: 'Neris', value: 'Neris', weights: [300]},
		{label: 'New CM Mono', value: 'NewCMMono10', weights: [400]},
		{label: 'New CM Sans', value: 'NewCMSans10', weights: [300]},
		{label: 'Open Sans Condensed', value: 'OpenSansCondensed', weights: [300]},
		{label: 'PT Root UI', value: 'PTRootUI', weights: [300, 400]},
		{label: 'Phenomena', value: 'Phenomena', weights: [300, 400]},
		{label: 'Phonk Sans', value: 'PhonkSans', weights: [300]},
		{label: 'TupoVyaz', value: 'TupoVyaz', weights: [400]},
		{label: 'Ubuntu', value: 'Ubuntu', weights: [300, 400]},
		{label: 'VDS', value: 'VDS', weights: [400]},
		{label: 'VDS Compensated', value: 'VDSCompensated', weights: [300]},
		{label: 'Yanone Kaffeesatz', value: 'YanoneKaffeesatz', weights: [300, 400]},
		{label: 'Zector', value: 'Zector', weights: [400]},
	]
	...
	function applyFonts(heading: string, body: string) {
		...
		// Загрузить локальные шрифты из app/assets/fonts/variants/
		const headingFont = headingFonts.find(f => f.value === heading)
		const bodyFont = bodyFonts.find(f => f.value === body)

		if (headingFont) {
			loadFont(headingFont.value, headingFont.weights)
		}
		if (bodyFont) {
			loadFont(bodyFont.value, bodyFont.weights)
		}
